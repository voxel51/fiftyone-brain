...
class DuplicatesResults(fob.BrainResults):
    ...
    def plot_distances(self, bins=100, logx=False, logy=False):
        ...
        Args:
            ...
            logx (False): whether to use log x-scale
            logy (False): whether to use log y-scale

        Returns:
            a matplotlib figure
        """
        return fbd.plot_distances(self, bins=bins, logx=logx, logy=logy)
    ...
    def visualize_duplicates(self, visualization=None):
        ...
        return fbd.visualize_duplicates(self, visualization)

    def visualize_unique(self, visualization=None):
        """Generates an interactive scatterplot of the results generated by the
        ...
        return fbd.visualize_unique(self, visualization)
